...
function _formatMessage(message, messages, root, path) {
  switch (message.type) {
    ...
    case 'Blame':
      {
        var see = message.path !== '' ? ' See ' + (path.includes(message.path) ? 'line ' + message.line : '.' + (0, _slash2.default)(message.path.replace(root, '')) + ':' + message.line) : '';
...
function executeFlow(stdin, root, filepath) {
  ...
  .filter(function (message) {
    ...
    var _message = (0, _toArray3.default)(message),
        ...
        remainingMessages = _message.slice(1);
